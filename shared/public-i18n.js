...
(function (global) {
  const DICT = {
    en: {
      ...
      'tenant.settings.contactInfo': 'Contact Information', 'tenant.settings.phone': 'Phone Number',
      'tenant.settings.emailReadonlyHint': 'Your email is your login and is not editable here — contact your property manager if you need to update it.',
      'tenant.settings.notifications': 'Notification Preferences',
      'tenant.moveout.title': '🚪 Move-Out &amp; Deposit Return', 'tenant.moveout.movedOutOn': 'You moved out on',
      'tenant.moveout.viewStatement': 'View Full Statement', 'tenant.moveout.date': 'Move-Out Date',
      'tenant.moveout.deposit': 'Deposit Received', 'tenant.moveout.deductions': 'Deductions',
      'tenant.moveout.item': 'item', 'tenant.moveout.items': 'items',
      'tenant.moveout.refundDue': 'Refund Due to You', 'tenant.moveout.youOwe': 'Amount You Owe',
      'tenant.renewal.endsIn': 'Your lease ends in', 'tenant.renewal.day': 'day', 'tenant.renewal.days': 'days',
      'tenant.renewal.alreadyEnded': 'Your lease end date has passed',
      'tenant.renewal.prompt': 'Interested in staying? Let your property manager know.',
      'tenant.renewal.requestButton': 'Request Renewal',
      'tenant.renewal.requestSent': 'Renewal request sent', 'tenant.renewal.willBeInTouch': 'your property manager will be in touch',
    ...
    es: {
      ...
      'tenant.settings.contactInfo': 'Información de Contacto', 'tenant.settings.phone': 'Número de Teléfono',
      'tenant.settings.emailReadonlyHint': 'Tu correo es tu inicio de sesión y no se puede editar aquí — contacta a tu administrador de propiedad si necesitas actualizarlo.',
      'tenant.settings.notifications': 'Preferencias de Notificación',
      'tenant.moveout.title': '🚪 Salida y Devolución de Depósito', 'tenant.moveout.movedOutOn': 'Saliste el',
      'tenant.moveout.viewStatement': 'Ver Estado de Cuenta Completo', 'tenant.moveout.date': 'Fecha de Salida',
      'tenant.moveout.deposit': 'Depósito Recibido', 'tenant.moveout.deductions': 'Deducciones',
      'tenant.moveout.item': 'artículo', 'tenant.moveout.items': 'artículos',
      'tenant.moveout.refundDue': 'Reembolso para Ti', 'tenant.moveout.youOwe': 'Monto que Debes',
      'tenant.renewal.endsIn': 'Tu contrato termina en', 'tenant.renewal.day': 'día', 'tenant.renewal.days': 'días',
      'tenant.renewal.alreadyEnded': 'La fecha de finalización de tu contrato ya pasó',
      'tenant.renewal.prompt': '¿Interesado en quedarte? Avísale a tu administrador de propiedad.',
      'tenant.renewal.requestButton': 'Solicitar Renovación',
      'tenant.renewal.requestSent': 'Solicitud de renovación enviada', 'tenant.renewal.willBeInTouch': 'tu administrador de propiedad se pondrá en contacto',
