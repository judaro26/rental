        ...
        await transporter.sendMail({
          ...
          html: `<div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:520px;margin:auto;background:#fff;border-radius:4px;overflow:hidden;">
            ...
            <div style="padding:28px 32px;">
              ...
              <p style="font-size:14px;color:#6B7280;margin:0 0 20px;">Hi ${tenantName||'there'}, we received your message and will get back to you as soon as possible.</p>
              ...
              <p style="font-size:12px;color:#9CA3AF;margin:0;">You will receive a reply at this email address. Please do not hesitate to reach out again if you have any urgent concerns.</p>
            </div>
            <div style="background:#F7F4EF;padding:16px 32px;text-align:center;">
              <p style="font-size:11px;color:#9CA3AF;">This is an automated confirmation from ${siteName||'your property manager'}.</p>
            </div>
          </div>`,
        });
      } catch(emailErr) { console.warn('Tenant confirmation email failed:', emailErr.message); }
    }
